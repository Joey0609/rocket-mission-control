  ...
  const themes = [
    ...
    },
    {
      ...
      vars: {
        ...
        "--line": "rgba(73, 50, 25, 0.14)",
        "--glow": "rgba(157, 122, 49, 0.22)",
        "--surface-1": "rgba(255, 255, 255, 0.84)",
        "--surface-2": "rgba(255, 255, 255, 0.91)",
        "--surface-3": "#fffbf4",
        "--surface-input": "rgba(255, 255, 255, 0.96)",
        "--surface-button": "rgba(255, 248, 236, 0.98)",
        "--surface-hero": "linear-gradient(135deg, rgba(255, 243, 218, 0.95), rgba(252, 224, 168, 0.86))",
        "--surface-axis": "linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(255, 251, 244, 0.86))",
        "--surface-axis-tag": "rgba(255, 255, 255, 0.96)",
        "--link": "#966d21"
      }
    },
    {
      ...
      vars: {
        ...
        "--glow": "rgba(45, 124, 184, 0.22)",
        "--surface-1": "rgba(255, 255, 255, 0.82)",
        "--surface-2": "rgba(255, 255, 255, 0.9)",
        "--surface-3": "#f7fcff",
        "--surface-input": "rgba(255, 255, 255, 0.95)",
        "--surface-button": "rgba(241, 249, 255, 0.98)",
        "--surface-hero": "linear-gradient(135deg, rgba(230, 243, 255, 0.95), rgba(196, 223, 244, 0.86))",
        "--surface-axis": "linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(247, 252, 255, 0.86))",
        "--surface-axis-tag": "rgba(255, 255, 255, 0.96)",
        "--link": "#2a73aa"
      }
    },
    {
      ...
      vars: {
        ...
        "--danger": "#ae5663",
        "--panel": "rgba(255, 255, 255, 0.9)",
        "--line": "rgba(35, 61, 49, 0.14)",
        "--glow": "rgba(47, 141, 98, 0.22)",
        "--surface-1": "rgba(255, 255, 255, 0.82)",
        "--surface-2": "rgba(255, 255, 255, 0.9)",
        "--surface-3": "#f7fcf8",
        "--surface-input": "rgba(255, 255, 255, 0.95)",
        "--surface-button": "rgba(240, 248, 242, 0.98)",
        "--surface-hero": "linear-gradient(135deg, rgba(228, 244, 233, 0.95), rgba(196, 225, 207, 0.86))",
        "--surface-axis": "linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(247, 252, 248, 0.86))",
        "--surface-axis-tag": "rgba(255, 255, 255, 0.96)",
        "--link": "#2a825a"
      }
    },
    {
      ...
      vars: {
        ...
        "--danger": "#b54f5f",
        "--panel": "rgba(255, 255, 255, 0.9)",
        "--line": "rgba(74, 46, 42, 0.14)",
        "--glow": "rgba(177, 106, 93, 0.22)",
        "--surface-1": "rgba(255, 255, 255, 0.82)",
        "--surface-2": "rgba(255, 255, 255, 0.9)",
        "--surface-3": "#fff8f6",
        "--surface-input": "rgba(255, 255, 255, 0.95)",
        "--surface-button": "rgba(255, 244, 241, 0.98)",
        "--surface-hero": "linear-gradient(135deg, rgba(255, 232, 226, 0.95), rgba(245, 202, 194, 0.86))",
        "--surface-axis": "linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(255, 248, 246, 0.86))",
        "--surface-axis-tag": "rgba(255, 255, 255, 0.96)",
        "--link": "#a76053"
      }
    },
